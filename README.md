...
- `figure3/` :  
  - `figure3.tiff` - Figure 3 部分复现结果图（原作者未提供完整数据，仅提供 R 代码，仓库链接：https://github.com/gerardhros/phd_luncheng/tree/main/articles/paper3）  
  - `43016_2024_1076_MOESM11_ESM.xlsx` - Figure 3 使用的公开补充数据
- `README.md` - 仓库说明文件
...
2. **Figure 3** 仅完成部分复现，原因在于原作者未提供完整原始数据（仅提供 R 代码，仓库链接：https://github.com/gerardhros/phd_luncheng/tree/main/articles/paper3），本组只能基于公开补充材料和论文方法说明进行部分重建。  
3. 所有复现图表均使用 R 语言绘制，生成图像为 `.tiff` 格式，保留原始分辨率。  
4. 数据来源参照论文正文、公开数据库和补充材料，包括气候、土壤、肥料输入、农田氮利用效率、土地利用数据及 FAO/FAOSTAT 数据等。
